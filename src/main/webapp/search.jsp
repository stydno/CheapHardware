...
<html>
    ...
    <%        if (session.getAttribute("searchAds") != null) {
            List<Advertisement> ads = (List<Advertisement>) session.getAttribute("searchAds");
            String info = "<center><table border=1><tr><td><center>";
